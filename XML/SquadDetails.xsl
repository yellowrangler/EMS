	...
	<xsl:template match="//dataroot" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
		<html>
			<head>
				...
				<title>SquadDetails</title>
				<style type="text/css"></style>
			</head>
			<body link="#0c0000" vlink="#050000">
				<table border="1" bgcolor="#ffffff" cellspacing="0" cellpadding="0" id="CTRL1">
					<colgroup>
						<col style="TEXT-ALIGN: right; WIDTH: 0.5312in"/>
						<col style="WIDTH: 1.1041in"/>
						<col style="WIDTH: 1.9791in"/>
						<col style="WIDTH: 2.0104in"/>
						<col style="WIDTH: 2.2708in"/>
						<col style="WIDTH: 1.6354in"/>
						<col style="WIDTH: 1.7291in"/>
						<col style="WIDTH: 1.0625in"/>
						<col style="WIDTH: 0.9375in"/>
						<col style="WIDTH: 0.9166in"/>
						<col style="WIDTH: 0.9375in"/>
						<col style="WIDTH: 0.9375in"/>
						<col style="WIDTH: 0.9375in"/>
						<col style="WIDTH: 0.9375in"/>
						<col style="WIDTH: 0.9375in"/>
						<col style="WIDTH: 0.9375in"/>
						<col style="WIDTH: 0.5729in"/>
						<col style="WIDTH: 2.052in"/>
						<col style="WIDTH: 2.0833in"/>
						<col style="WIDTH: 2.3437in"/>
						<col style="WIDTH: 1.677in"/>
						<col style="WIDTH: 2.3958in"/>
						<col style="WIDTH: 2.1666in"/>
						<col style="TEXT-ALIGN: right; WIDTH: 1.5312in"/>
						<col style="TEXT-ALIGN: right; WIDTH: 2.2083in"/>
						<col style="TEXT-ALIGN: right; WIDTH: 2.2395in"/>
						<col style="TEXT-ALIGN: right; WIDTH: 1.125in"/>
					</colgroup>
					<tbody>
						<tr>
							<td>
							...
							<td>
								<div align="center">
									<strong>Squad Manager Last Name</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>Squad Manager First Name</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>Squad Manager E-mail Address</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>Squad Manager  Title</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>Squad Business Phone</strong>
								</div>
							</td>
							<td>
								<div align="center">
							...
							<td>
								<div align="center">
									<strong>Squad Historical Notes</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>Squad Background Image Attachment</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>Medical Director Last Name</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>Medical Director First Name</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>Medical Director E-mail Address</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>Medical Director Title</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>Medical Director Business Phone</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>Medical Director Fax Number</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>Squad Charter Date</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>Squad Membership Start Date</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>Squad Membership Term Date</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>Squad Active</strong>
								</div>
							</td>
						</tr>
					</tbody>
					<tbody id="CTRL2">
						<xsl:for-each select="SquadDetails">
							...
							<tr>
								...
								<td>
									<xsl:value-of select="Squad_x0020_Manager_x0020_Last_x0020_Name"/>
								</td>
								<td>
									<xsl:value-of select="Squad_x0020_Manager_x0020_First_x0020_Name"/>
								</td>
								<td>
									<xsl:value-of select="Squad_x0020_Manager_x0020_E-mail_x0020_Address"/>
								</td>
								<td>
									<xsl:value-of select="Squad_x0020_Manager_x0020__x0020_Title"/>
								</td>
								<td>
									<xsl:value-of select="Squad_x0020_Business_x0020_Phone"/>
								</td>
								<td>
									<xsl:value-of select="Fax_x0020_Number"/>
								</td>
								<td>
									<xsl:value-of select="Address_x0020_1"/>
								</td>
								<td>
									<xsl:value-of select="Address_x0020_2"/>
								</td>
								<td>
								...
								<td>
									<xsl:value-of select="Squad_x0020_Historical_x0020_Notes" disable-output-escaping="yes"/>
								</td>
								<td>
									<xsl:value-of select="Squad_x0020_Background_x0020_Image_x0020_Attachment"/>
								</td>
								<td>
									<xsl:value-of select="Medical_x0020_Director_x0020_Last_x0020_Name"/>
								</td>
								<td>
									<xsl:value-of select="Medical_x0020_Director_x0020_First_x0020_Name"/>
								</td>
								<td>
									<xsl:value-of select="Medical_x0020_Director_x0020_E-mail_x0020_Address"/>
								</td>
								<td>
									<xsl:value-of select="Medical_x0020_Director_x0020_Title"/>
								</td>
								<td>
									<xsl:value-of select="Medical_x0020_Director_x0020_Business_x0020_Phone"/>
								</td>
								<td>
									<xsl:value-of select="Medical_x0020_Director_x0020_Fax_x0020_Number"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('Squad_x0020_Charter_x0020_Date', 'Short Date', '', '', 7)"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('Squad_x0020_Membership_x0020_Start_x0020_Date', 'Short Date', '', '', 7)"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('Squad_x0020_Membership_x0020_Term_x0020_Date', 'Short Date', '', '', 7)"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('Squad_x0020_Active', 'Yes/No', '', '', 11)"/>
								</td>
							</tr>
						</xsl:for-each>
					</tbody>
