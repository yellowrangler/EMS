	...
	<xsl:template match="//dataroot" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
		<html>
			<head>
				...
				<title>EquipmentInventory</title>
			...
			<body link="#0c0000" vlink="#050000">
				<table border="1" bgcolor="#ffffff" cellspacing="0" cellpadding="0" id="CTRL1">
					<colgroup>
						...
						<col style="TEXT-ALIGN: right; WIDTH: 0.9375in"/>
						<col style="WIDTH: 3.3125in"/>
						<col style="TEXT-ALIGN: right; WIDTH: 0.9375in"/>
						<col style="WIDTH: 0.9375in"/>
						<col style="TEXT-ALIGN: right; WIDTH: 0.9375in"/>
						<col style="TEXT-ALIGN: right; WIDTH: 1.1875in"/>
						<col style="TEXT-ALIGN: right; WIDTH: 1.125in"/>
						<col style="TEXT-ALIGN: right; WIDTH: 1.3125in"/>
						<col style="TEXT-ALIGN: right; WIDTH: 1.2083in"/>
						<col style="WIDTH: 0.9375in"/>
						<col style="WIDTH: 1.1875in"/>
						<col style="WIDTH: 0.9375in"/>
						<col style="WIDTH: 0.9375in"/>
						<col style="WIDTH: 0.9375in"/>
						<col style="WIDTH: 0.9375in"/>
					...
					<tbody id="CTRL2">
						<xsl:for-each select="EquipmentInventory">
							...
							<tr>
								...
								<td>
									<xsl:value-of select="fx:FormatFromXSL('In_x0020_Service', 'Yes/No', '', '', 11)"/>
								</td>
								<td>
								...
								<td>
									<xsl:value-of select="fx:FormatFromXSL('Purchase_x0020_Price', 'Currency', 'auto', '1033', 6)"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('Current_x0020_Value', 'Currency', 'auto', '1033', 6)"/>
								</td>
								<td>
