	...
	<xsl:template match="//dataroot" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
		<html>
			<head>
				...
				<title>Squad Member Equipment</title>
				<style type="text/css">
			...
			<body link="#0c0000" vlink="#050000">
				...
				<xsl:for-each select="SquadMemberEquipment">
					...
					<div style="BORDER-STYLE: none; WIDTH: 6.1694in; BACKGROUND-COLOR: #ffffff; VISIBILITY: visible; HEIGHT: 5.25in; POSITION: relative">
						<span class="Style0" style="TEXT-ALIGN: right; LEFT: 2.75in; TOP: 0.6666in; WIDTH: 1.5833in; HEIGHT: 0.2187in; OVERFLOW: hidden; POSITION: absolute">
							<xsl:value-of select="SquadMemberID"/>
						</span>
						<span class="Style1" style="LEFT: 1.5in; TOP: 0.6666in; WIDTH: 1.0833in; HEIGHT: 0.2222in; OVERFLOW: hidden; POSITION: absolute">Squad Member</span>
						<span class="Style0" style="TEXT-ALIGN: right; LEFT: 2.7916in; TOP: 1.in; WIDTH: 1.5416in; HEIGHT: 0.2187in; OVERFLOW: hidden; POSITION: absolute">
							<xsl:value-of select="EquipmentInventoryID"/>
						</span>
						<span class="Style1" style="LEFT: 1.0416in; TOP: 1.in; WIDTH: 1.5833in; HEIGHT: 0.2222in; OVERFLOW: hidden; POSITION: absolute">Equipment Description</span>
						<span class="Style2" style="TEXT-ALIGN: right; LEFT: 2.052in; TOP: 2.177in; WIDTH: 1.875in; HEIGHT: 0.2187in; OVERFLOW: hidden; POSITION: absolute">
							<xsl:value-of select="fx:FormatFromXSL('EquipmentAssignedDate', '', '', '', 7)"/>
						</span>
						<span class="Style1" style="LEFT: 0.6944in; TOP: 2.177in; WIDTH: 1.177in; HEIGHT: 0.2187in; OVERFLOW: hidden; POSITION: absolute">Assigned Date</span>
						<span class="Style2" style="TEXT-ALIGN: right; LEFT: 2.052in; TOP: 2.3958in; WIDTH: 1.875in; HEIGHT: 0.2187in; OVERFLOW: hidden; POSITION: absolute">
							<xsl:value-of select="fx:FormatFromXSL('EquipmentReturnedDate', '', '', '', 7)"/>
						</span>
						<span class="Style1" style="LEFT: 0.6944in; TOP: 2.3958in; WIDTH: 1.177in; HEIGHT: 0.2187in; OVERFLOW: hidden; POSITION: absolute">Returned Date</span>
						<span class="Style1" style="LEFT: 2.052in; TOP: 1.9583in; WIDTH: 1.875in; HEIGHT: 0.2187in; OVERFLOW: hidden; POSITION: absolute">Equipment Active</span>
						<span class="Style2" style="LEFT: 2.052in; TOP: 2.6145in; WIDTH: 2.2812in; HEIGHT: 0.927in; OVERFLOW: hidden; POSITION: absolute">
							<xsl:value-of select="EquipmentNotes"/>
						</span>
						<span class="Style1" style="LEFT: 0.6944in; TOP: 2.6145in; WIDTH: 1.177in; HEIGHT: 0.2187in; OVERFLOW: hidden; POSITION: absolute">Equipment Notes</span>
					</div>
				</xsl:for-each>
