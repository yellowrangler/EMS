				...
				<table border="1" bgcolor="#ffffff" cellspacing="0" cellpadding="0" id="CTRL1">
					...
					<tbody>
						<tr>
							...
							<td>
								<div align="center">
									<strong>National Registry Number</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>CPR CertificationExpirationDate</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>CertificationLevel</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>CertificationExpirationDate</strong>
								</div>
							</td>
							<td>
								<div align="center">
					...
					<tbody id="CTRL2">
						<xsl:for-each select="Members_x0020_Extended">
							...
							<tr>
								<td>
									<xsl:value-of select="File_x0020_As"/>
								</td>
								<td>
									<xsl:value-of select="Member_x0020_Name"/>
								</td>
								<td>
								...
								<td>
									<xsl:value-of select="SendMeSquadTextAlerts"/>
								</td>
								<td>
									<xsl:value-of select="SendMeSquadEMails"/>
								</td>
								<td>
									<xsl:value-of select="SendMePromotionalEMails"/>
								</td>
								<td>
								...
								<td>
									<xsl:value-of select="SquadIssuedEquipment"/>
								</td>
								<td>
