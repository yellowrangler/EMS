	...
	<xsl:template match="//dataroot" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
		<html>
			<head>
				...
				<title>SquadMemberEquipment</title>
			...
			<body link="#0c0000" vlink="#050000">
				<table border="1" bgcolor="#ffffff" cellspacing="0" cellpadding="0" id="CTRL1">
					<colgroup>
						...
						<col style="TEXT-ALIGN: right; WIDTH: 1.375in"/>
						<col style="TEXT-ALIGN: right; WIDTH: 1.7604in"/>
						<col style="TEXT-ALIGN: right; WIDTH: 1.8854in"/>
						<col style="TEXT-ALIGN: right; WIDTH: 1.9062in"/>
						<col style="TEXT-ALIGN: right; WIDTH: 1.4062in"/>
						<col style="WIDTH: 1.3854in"/>
					</colgroup>
					<tbody>
						<tr>
							<td>
							...
							<td>
								<div align="center">
									<strong>SquadID</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>SquadMemberID</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>EquipmentInventoryID</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>EquipmentAssignedDate</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>EquipmentReturnedDate</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>EquipmentActive</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>EquipmentNotes</strong>
								</div>
							</td>
						</tr>
					</tbody>
					<tbody id="CTRL2">
						<xsl:for-each select="SquadMemberEquipment">
							...
							<tr>
								...
								<td>
									<xsl:value-of select="fx:FormatFromXSL('EquipmentAssignedDate', 'Short Date', '', '', 7)"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('EquipmentReturnedDate', 'Short Date', '', '', 7)"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('EquipmentActive', 'Yes/No', '', '', 11)"/>
								</td>
								<td>
