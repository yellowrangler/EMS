				...
				<table border="1" bgcolor="#ffffff" cellspacing="0" cellpadding="0" id="CTRL1">
					...
					<tbody>
						<tr>
							...
							<td>
								<div align="center">
									<strong>AffiliatedSquadID</strong>
								</div>
							</td>
							<td>
								<div align="center">
							...
							<td>
								<div align="center">
									<strong>SendMeFundRaisingEMails</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>SendMeCommunityEventsEMails</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>SendMeVolunteerOpportunityEMails</strong>
								</div>
							</td>
						</tr>
					</tbody>
					<tbody id="CTRL2">
						<xsl:for-each select="CommunityMember">
							...
							<tr>
								...
								<td>
									<xsl:value-of select="AffiliatedSquadID"/>
								</td>
								<td>
								...
								<td>
									<xsl:value-of select="fx:FormatFromXSL('SendMeFundRaisingEMails', 'Yes/No', '', '', 11)"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('SendMeCommunityEventsEMails', 'Yes/No', '', '', 11)"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('SendMeVolunteerOpportunityEMails', 'Yes/No', '', '', 11)"/>
								</td>
							</tr>
						</xsl:for-each>
					</tbody>
