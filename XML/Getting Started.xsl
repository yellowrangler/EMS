...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt" xmlns:fx="#fx-functions" exclude-result-prefixes="msxsl fx">
	...
	<xsl:template match="//dataroot" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
		...
		.Style1 { BORDER-STYLE: none; BACKGROUND-COLOR: transparent; BORDER-WIDTH: 1px; BORDER-COLOR: #000000; VISIBILITY: visible }
	
		.Style2 { BORDER-STYLE: solid; BORDER-WIDTH: 1px; BORDER-COLOR: #ffffff; VISIBILITY: visible }
	
		.Style3 { BORDER-STYLE: solid; BACKGROUND-COLOR: #ffffff; BORDER-WIDTH: 1px; BORDER-COLOR: #000000; VISIBILITY: visible }
	
		.Style4 { COLOR: #446087; BACKGROUND-COLOR: transparent; VISIBILITY: visible; FONT-WEIGHT: 400; FONT-SIZE: 11pt; FONT-FAMILY: Calibri; FONT-STYLE: normal; TEXT-DECORATION: underline }
	
		.Style5 { BORDER-STYLE: inset; BORDER-WIDTH: 2px; BORDER-COLOR: ; VISIBILITY: visible }
	
		.Style6 { BORDER-STYLE: none; COLOR: #446087; BACKGROUND-COLOR: transparent; BORDER-WIDTH: 1px; BORDER-COLOR: #000000; TEXT-ALIGN: general; WRITING-MODE: lr-tb; VISIBILITY: visible; FONT-WEIGHT: 400; FONT-SIZE: 11pt; FONT-FAMILY: Calibri; FONT-STYLE: normal; TEXT-DECORATION: none; PADDING-TOP: 0.in; PADDING-BOTTOM: 0.in; PADDING-RIGHT: 0.in; PADDING-LEFT: 0.in }
	
		.Style7 { BORDER-STYLE: none; COLOR: #000000; BACKGROUND-COLOR: transparent; BORDER-WIDTH: 1px; BORDER-COLOR: #000000; TEXT-ALIGN: general; WRITING-MODE: lr-tb; VISIBILITY: visible; FONT-WEIGHT: 400; FONT-SIZE: 11pt; FONT-FAMILY: Calibri; FONT-STYLE: normal; TEXT-DECORATION: none; PADDING-TOP: 0.in; PADDING-BOTTOM: 0.in; PADDING-RIGHT: 0.in; PADDING-LEFT: 0.in }
	
		.Style8 { BORDER-STYLE: none; COLOR: #000000; BACKGROUND-COLOR: transparent; BORDER-WIDTH: 1px; BORDER-COLOR: #000000; TEXT-ALIGN: general; WRITING-MODE: lr-tb; VISIBILITY: visible; FONT-WEIGHT: 700; FONT-SIZE: 14pt; FONT-FAMILY: Calibri; FONT-STYLE: normal; TEXT-DECORATION: none; PADDING-TOP: 0.in; PADDING-BOTTOM: 0.in; PADDING-RIGHT: 0.in; PADDING-LEFT: 0.in }
	
		.Style9 { BORDER-STYLE: solid; BORDER-WIDTH: 2pt; BORDER-COLOR: #446087; VISIBILITY: visible }
	
		.Style10 { COLOR: #6a89a1; BACKGROUND-COLOR: transparent; VISIBILITY: visible; FONT-WEIGHT: 400; FONT-SIZE: 11pt; FONT-FAMILY: Calibri; FONT-STYLE: normal; TEXT-DECORATION: underline }
	
		.Style11 { COLOR: #446087; BACKGROUND-COLOR: transparent; VISIBILITY: visible; FONT-WEIGHT: 400; FONT-SIZE: 9pt; FONT-FAMILY: Segoe UI; FONT-STYLE: normal; TEXT-DECORATION: underline }
	</style>
			</head>
			<body link="#0c0000" vlink="#050000">
				<xsl:variable name="GlobalGroup" select="Settings"/>
				<!-- Calculate expressions and running sums -->
				<xsl:value-of select="fx:CalculateExpressions_Global($GlobalGroup[1], $GlobalGroup)"/>
				<div style="BORDER-STYLE: none; WIDTH: 9.375in; BACKGROUND-COLOR: #f2f9cb; VISIBILITY: visible; HEIGHT: 0.4791in; POSITION: relative">
					<span class="Style0" style="LEFT: 0.8576in; TOP: 0.0416in; WIDTH: 6.302in; HEIGHT: 0.377in; OVERFLOW: hidden; POSITION: absolute">Getting Started with Contacts</span>
					<IMG id="Auto_Logo0" class="Style1" style="LEFT: 0.2083in; TOP: 0.0416in; WIDTH: 0.5625in; HEIGHT: 0.4375in; BACKGROUND-COLOR: silver; POSITION: absolute" SRC="Images\Auto_Logo0.bmp"/>
					<hr id="Line8" class="Style2" style="LEFT: 0.in; TOP: 0.4576in; WIDTH: 9.3312in; HEIGHT: 0.in; POSITION: absolute"/>
				</div>
				<xsl:for-each select="Settings">
					<!-- Calculate expressions and running sums -->
					<xsl:value-of select="fx:CalculateExpressions_Detail(., $GlobalGroup)"/>
					<div style="BORDER-STYLE: none; WIDTH: 9.375in; BACKGROUND-COLOR: #446087; VISIBILITY: visible; HEIGHT: 6.in; POSITION: relative">
						<div id="Box9" class="Style3" style="LEFT: 0.2916in; TOP: 0.3333in; WIDTH: 8.7083in; HEIGHT: 5.2916in; POSITION: absolute">
							<xsl:value-of disable-output-escaping="yes" select="' '"/>
						</div>
						<input type="checkbox" style="LEFT: 0.4583in; TOP: 5.25in; HEIGHT: 0.1666in; POSITION: absolute">
							<xsl:if test="fx:GetValue('ShowGettingStarted', 11)">
								<xsl:attribute name="checked"/>
							</xsl:if>
						</input>
						<span class="Style6" style="LEFT: 0.6145in; TOP: 5.2083in; WIDTH: 3.5104in; HEIGHT: 0.2083in; OVERFLOW: hidden; POSITION: absolute">Show Getting Started when this database is opened</span>
						<span class="Style7" style="LEFT: 0.6354in; TOP: 1.0833in; WIDTH: 8.1666in; HEIGHT: 0.25in; OVERFLOW: hidden; POSITION: absolute">We recommend that you watch these two short videos to help you understand this database and Microsoft Access. 
</span>
						<span class="Style7" style="LEFT: 0.625in; TOP: 4.4166in; WIDTH: 8.1666in; HEIGHT: 0.25in; OVERFLOW: hidden; POSITION: absolute">Once you've had a chance to use the Contact Management database, please let us know how we're doing. 
</span>
						<span class="Style8" style="LEFT: 0.625in; TOP: 0.75in; WIDTH: 8.1666in; HEIGHT: 0.25in; OVERFLOW: hidden; POSITION: absolute">Welcome to the Contacts Management Database!
</span>
						<hr id="LineAboveProvideFeedback" class="Style9" style="LEFT: 0.625in; TOP: 4.3333in; WIDTH: 8.125in; HEIGHT: 0.in; POSITION: absolute"/>
						<span class="Style7" style="LEFT: 0.625in; TOP: 3.7916in; WIDTH: 2.9166in; HEIGHT: 0.2083in; OVERFLOW: hidden; POSITION: absolute">Do you use Microsoft Outlook? 
</span>
						<span class="Style7" style="LEFT: 0.625in; TOP: 3.4583in; WIDTH: 3.1666in; HEIGHT: 0.1979in; OVERFLOW: hidden; POSITION: absolute">Video: Using the Contact Management Database</span>
						<span class="Style7" style="LEFT: 4.0416in; TOP: 3.4583in; WIDTH: 3.625in; HEIGHT: 0.1979in; OVERFLOW: hidden; POSITION: absolute">Video: Modifying the Contacts Management Database</span>
						<span class="Style7" style="LEFT: 6.4375in; TOP: 0.375in; WIDTH: 0.125in; HEIGHT: 0.1979in; OVERFLOW: hidden; POSITION: absolute">|</span>
						<span class="Style7" style="LEFT: 7.5in; TOP: 0.375in; WIDTH: 0.125in; HEIGHT: 0.1979in; OVERFLOW: hidden; POSITION: absolute">|</span>
						<span class="Style7" style="LEFT: 8.3645in; TOP: 0.375in; WIDTH: 0.125in; HEIGHT: 0.1979in; OVERFLOW: hidden; POSITION: absolute">|</span>
						<span class="Style7" style="LEFT: 4.0416in; TOP: 3.7916in; WIDTH: 4.75in; HEIGHT: 0.4166in; OVERFLOW: hidden; POSITION: absolute">Find a Contact Management Database expert and track your contacts like a pro. 
</span>
					</div>
				</xsl:for-each>
				<!-- Prepare for any expressions in the report or page footer -->
				<xsl:value-of select="fx:PrepExpressions($GlobalGroup[1], $GlobalGroup)"/>
				<div style="BORDER-STYLE: none; WIDTH: 9.375in; BACKGROUND-COLOR: #ffffff; VISIBILITY: visible; HEIGHT: 0.in; POSITION: relative"></div>
			</body>
		</html>
	</xsl:template>
