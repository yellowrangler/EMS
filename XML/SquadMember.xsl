		...
		<html>
			...
			<body link="#0c0000" vlink="#050000">
				<table border="1" bgcolor="#ffffff" cellspacing="0" cellpadding="0" id="CTRL1">
					<colgroup>
						<col style="TEXT-ALIGN: right; WIDTH: 0.6666in"/>
						<col style="WIDTH: 0.9375in"/>
						<col style="WIDTH: 0.9375in"/>
						<col style="TEXT-ALIGN: right; WIDTH: 0.9375in"/>
						<col style="WIDTH: 0.9375in"/>
						<col style="WIDTH: 0.9375in"/>
						<col style="WIDTH: 1.6666in"/>
						<col style="WIDTH: 0.9375in"/>
						<col style="WIDTH: 0.9375in"/>
						<col style="WIDTH: 0.9375in"/>
						<col style="WIDTH: 0.9375in"/>
					...
					<tbody>
						<tr>
							...
							<td>
								<div align="center">
									<strong>State EMS Number</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>NREMT Number</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>CPR Expiration Date</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>Ceertification Level</strong>
								</div>
							</td>
							<td>
								<div align="center">
							...
							<td>
								<div align="center">
									<strong>SendMeSquadTextAlerts</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>SendMeSquadEMails</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>SendMePromotionalEMails</strong>
								</div>
							</td>
							<td>
								<div align="center">
							...
							<td>
								<div align="center">
									<strong>Trouser Size</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>SquadIssuedEquipment</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>OuterwearSize</strong>
								</div>
							</td>
							<td>
								<div align="center">
					...
					<tbody id="CTRL2">
						<xsl:for-each select="SquadMember">
							...
							<tr>
								...
								<td>
									<xsl:value-of select="Login_x0020_ID"/>
								</td>
								<td>
								...
								<td>
									<xsl:value-of select="fx:FormatFromXSL('CPR_x0020_CertificationExpirationDate', 'Short Date', '', '', 7)"/>
								</td>
								<td>
									<xsl:value-of select="CertificationLevel"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('CertificationExpirationDate', 'Short Date', '', '', 7)"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('SendMeSquadTextAlerts', 'Yes/No', '', '', 11)"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('SendMeSquadEMails', 'Yes/No', '', '', 11)"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('SendMePromotionalEMails', 'Yes/No', '', '', 11)"/>
								</td>
								<td>
								...
								<td>
									<xsl:value-of select="fx:FormatFromXSL('SquadIssuedEquipment', 'Yes/No', '', '', 11)"/>
								</td>
								<td>
									<xsl:value-of select="OuterwearSize"/>
								</td>
								<td>
